...
\begin{enumerate}
    ...
    \item Las RBF de soporte global (gaussiana, multicuádrica e inversa)
    presentan una transición abrupta en el borde del círculo cuando la
    intensidad es alta (entre 10 y 50). La depresión generada no es suave
    en el perímetro debido a que el peso residual \(e^{-\varepsilon^2}\)
    es distinto de cero en \(r = R\).
\end{enumerate}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{docs/caso_base_triangulacion.png}
    \caption{Malla base sin deformar.}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\textwidth]{docs/gaussiana.png}
    \includegraphics[width=0.45\textwidth]{docs/multicuadrática.png}
    \caption{Resultados con función gaussiana (izquierda) y multicuádrica (derecha).}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\textwidth]{docs/multicuadrática_inversa.png}
    \includegraphics[width=0.45\textwidth]{docs/wendland.png}
