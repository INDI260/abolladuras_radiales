...
\begin{figure}[h]
    ...
    \caption{Resultado con función gaussiana.}
\end{figure}

\subsection{Multicuádrica}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\textwidth]{example-image}
    \caption{Resultado con función multicuádrica.}
\end{figure}

\subsection{Multicuádrica inversa}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\textwidth]{example-image}
    \caption{Resultado con función multicuádrica inversa.}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\textwidth]{example-image}
    \caption{Resultado con función Wendland \(\phi_{3,1}\).}
\end{figure}
